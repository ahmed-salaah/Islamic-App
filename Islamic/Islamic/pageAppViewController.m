...
- (void) createContentPages
{
    ...
    for (int i = 1; i < 605; i++)
    {
        NSString *contentString = [[NSString alloc]
                                   initWithFormat:@"<html><head></head><body><img width=\"960px\" src=\"page%d.png\"</body></html>",i];
...
//    UINavigationController *aNavigationController = [[UINavigationController alloc] initWithRootViewController:surahTableViewController];
    ...
    [self.navigationController pushViewController:surahTableViewController animated:YES];
